...
void AFreezableLiquid::BeginPlay()
{
	...
	Geometry->OnComponentEndOverlap.AddDynamic(this, &AFreezableLiquid::OnOverlapLeft);
}
...
void AFreezableLiquid::OnOverlapLeft(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
	FVector2D hit(OtherActor->GetActorLocation());
